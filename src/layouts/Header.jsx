  ...
  return (
    <>
      <header className={`w-[100%] h-[120px] fixed backdrop-blur-[10px] bg-[rgba(0,0,0,0.2)] z-[999] ${
        ...
        <nav className="myContainer flex justify-start items-center gap-[20px] h-[100%] sm:justify-between ">
          ...
          <ul className="link flex justify-start items-center flex-1 sm:hidden">
            <li className="">
          ...
          <ul className="w-[15%] flex justify-end sm:hidden">
