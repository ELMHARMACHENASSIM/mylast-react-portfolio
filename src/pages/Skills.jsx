        ...
        <div  className="backdrop-blur-[10px] bg-[rgba(255,255,255,0.05)] p-[50px] sm:p-[0px]">
          ...
          <div className="">
            ...
            <div className="flex justify-start sm:flex-col items-center w-[100%] gap-[50px]">
              ...
              <div className="flex  gap-[15px] justify-center items-center border-body-color border-[1px]  p-[10px] w-[150px] text-body-color">
                <img src={Tailwind}  className="w-[40px]" alt="" loading="lazy"/> <span>Tailwind</span>
              </div>
              <div className="flex  gap-[15px] justify-center items-center border-body-color border-[1px]  p-[10px] w-[150px] text-body-color">
                <img src={Bootstrap}  className="w-[40px]" alt="" loading="lazy"/> <span>Bootstrap</span>
              </div>
              <div className="flex  gap-[15px] justify-center items-center border-body-color border-[1px]  p-[10px] w-[150px] text-body-color">
                <img src={Sass}  className="w-[40px]" alt="" loading="lazy"/> <span>Sass</span>
              </div>
              <div className="flex  gap-[15px] justify-center items-center border-body-color border-[1px]  p-[10px] w-[150px] text-body-color">
                <img src={Laravel}  className="w-[40px]" alt="" loading="lazy"/> <span>laravel</span>
              </div>
            </div>
          </div>
          <div className="">
            ...
            <div className="flex justify-start sm:flex-col items-center w-[100%] gap-[50px]">
              ...
              <div className="flex  gap-[15px] justify-center items-center border-body-color border-[1px]  p-[10px] w-[150px] text-body-color">
                <img src={Github}  className="w-[40px]" alt="" loading="lazy"/> <span>GitHub</span>
              </div>
          ...
          <div className="">
            ...
            <div className="flex justify-start sm:flex-col items-center w-[100%] gap-[50px] sm:py-[20px]">
              ...
              <div className="flex  gap-[15px] justify-center items-center border-body-color border-[1px]  p-[10px] w-[150px] text-body-color">
                <img src={Figma}  className="w-[40px]" alt="" loading="lazy"/> <span>Figma</span>
              </div>
              <div className="flex  gap-[15px] justify-center items-center border-body-color border-[1px]  p-[10px] w-[150px] text-body-color">
                <img src={Photoshop}  className="w-[40px]" alt="" loading="lazy"/> <span>Photoshop</span>
              </div>
              <div className="flex  gap-[15px] justify-center items-center border-body-color border-[1px]  p-[10px] w-[150px] text-body-color">
                <img src={Illustrator}  className="w-[40px]" alt="" loading="lazy"/> <span>illustrator</span>
              </div>
              <div className="flex  gap-[15px] justify-center items-center border-body-color border-[1px]  p-[10px] w-[150px] text-body-color">
                <img src={Xd}  className="w-[40px]" alt="" loading="lazy"/> <span>Adobe Xd</span>
              </div>
            </div>
          </div>
        </div>
